...
Mod selection should prioritize gameplay mechanics such as player interaction and compatibility with other mods.

Some key points:

- Content: mods should add and change content in order to give players interesting things to do.
- Compatibility: mods that have explicit interoperability are preferred.
- Progression: mods shall not create shortcuts over large portions of other mods progression and resource balance.
- Duplicates: content such as items, recipes and loot should be solvable with a combination of Almost Unified, KubeJS and datapacks.
- Visuals: are welcome but are a minor factor.

## Structure mods

Structure mods should be more than adding/improving structures to look good. They need a reason to be there (think about Terraria structures).

Points to judge such mods:

- Navigability: the structure should be navigable on survival and free of micro obstacles.
